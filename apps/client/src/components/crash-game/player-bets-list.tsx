import { useCrashBets, useCrashTopWins } from '@/features/server/crash/hooks';
import { memo } from 'react';

const PlayerBetsList = memo(() => {
    const bets = useCrashBets();
    const topWins = useCrashTopWins();
                        ...
                        {topWins.map((win, i) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                    ...
                                    <span className="text-green-400 tabular-nums text-xs">
                                        {win.cashedOutAt.toFixed(2)}x
                                    </span>
                                </div>
                            </div>
                        ))}
