        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription className="flex flex-col space-y-4">
                    <span>
                        Manage channel-specific permissions for roles and users.
                        These permissions are not inherited from server-level
                        permissions. User permissions take precedence over role
                        permissions.
                    </span>
                    {!channel?.private && (
                        <Alert variant="destructive">
                            ...
                            <AlertDescription>
                                This is a public channel; everyone has access by
                                default. These permissions will not be applied
                    ...
                    {selectedOverrideId ? (
                        ...
                        <Card className="flex flex-1 items-center justify-center">
                            <CardContent className="py-12 text-center text-muted-foreground text-sm">
                                Select a role or user to edit permissions, or
                                add a new override
                            </CardContent>
                        </Card>
                    )}
