...
const subscribeToChannels = () => {
    ...
    const onChannelCreateSub = trpc.channels.onCreate.subscribe(undefined, {
        ...
        onError: (err) =>
            console.error('onChannelCreate subscription error:', err)
    });
    ...
    const onChannelDeleteSub = trpc.channels.onDelete.subscribe(undefined, {
        ...
        onError: (err) =>
            console.error('onChannelDelete subscription error:', err)
    });
    ...
    const onChannelUpdateSub = trpc.channels.onUpdate.subscribe(undefined, {
        ...
        onError: (err) =>
            console.error('onChannelUpdate subscription error:', err)
    });
    ...
    const onChannelPermissionsUpdateSub =
        trpc.channels.onPermissionsUpdate.subscribe(undefined, {
            ...
            onError: (err) =>
                console.error(
                    'onChannelPermissionsUpdate subscription error:',
                    err
                )
        });
    ...
    const onChannelReadStatesUpdateSub =
        trpc.channels.onReadStateUpdate.subscribe(undefined, {
            ...
            onError: (err) =>
                console.error(
                    'onChannelReadStatesUpdate subscription error:',
                    err
                )
        });

    const onChannelReadStatesDeltaSub =
        trpc.channels.onReadStateDelta.subscribe(undefined, {
            onData: (data) => {
            ...
            onError: (err) =>
                console.error(
                    'onChannelReadStatesDelta subscription error:',
                    err
                )
        });
