...
--> statement-breakpoint
CREATE INDEX `coinflip_games_creator_idx` ON `coinflip_games` (`creator_id`);--> statement-breakpoint
CREATE INDEX `coinflip_games_opponent_idx` ON `coinflip_games` (`opponent_id`);--> statement-breakpoint
CREATE INDEX `coinflip_games_status_idx` ON `coinflip_games` (`status`);--> statement-breakpoint
CREATE INDEX `coinflip_games_created_idx` ON `coinflip_games` (`created_at`);--> statement-breakpoint
CREATE TABLE `crash_bets` (
	...
	`created_at` integer NOT NULL,
	FOREIGN KEY (`round_id`) REFERENCES `crash_rounds`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
CREATE INDEX `crash_bets_round_idx` ON `crash_bets` (`round_id`);--> statement-breakpoint
CREATE INDEX `crash_bets_user_idx` ON `crash_bets` (`user_id`);--> statement-breakpoint
CREATE INDEX `crash_bets_round_user_idx` ON `crash_bets` (`round_id`,`user_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `crash_rounds_started_idx` ON `crash_rounds` (`started_at`);--> statement-breakpoint
CREATE INDEX `crash_rounds_ended_idx` ON `crash_rounds` (`ended_at`);--> statement-breakpoint
...
CREATE TABLE `roulette_bets` (
	...
	`ledger_entry_id` integer,
	`created_at` integer NOT NULL,
	FOREIGN KEY (`round_id`) REFERENCES `roulette_rounds`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
CREATE INDEX `roulette_bets_round_idx` ON `roulette_bets` (`round_id`);--> statement-breakpoint
CREATE INDEX `roulette_bets_user_idx` ON `roulette_bets` (`user_id`);--> statement-breakpoint
CREATE INDEX `roulette_bets_round_user_idx` ON `roulette_bets` (`round_id`,`user_id`);--> statement-breakpoint
CREATE TABLE `roulette_rounds` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`winning_number` integer NOT NULL,
	`lightning_numbers` text DEFAULT '[]' NOT NULL,
	`hash` text NOT NULL,
	`started_at` integer NOT NULL,
	`ended_at` integer
);
--> statement-breakpoint
CREATE INDEX `roulette_rounds_started_idx` ON `roulette_rounds` (`started_at`);--> statement-breakpoint
CREATE INDEX `roulette_rounds_ended_idx` ON `roulette_rounds` (`ended_at`);--> statement-breakpoint
...
CREATE INDEX `social_credit_votes_voter_target_created_idx` ON `social_credit_votes` (`voter_id`,`target_id`,`created_at`);--> statement-breakpoint
CREATE TABLE `sounds` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`name` text NOT NULL,
	`file_id` integer NOT NULL,
